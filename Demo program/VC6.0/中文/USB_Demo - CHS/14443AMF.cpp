...
void C14443AMF::OnReadcard() 
{
	...
	if(re == 0)
	{
		...
		str.Format("卡号: %02x %02x %02x %02x\r\n卡的内容:", pCode[0], pCode[1], pCode[2], pCode[3]);
...
void C14443AMF::OnWritecard() 
{
	...
	{
		CString str;
		str.Format("写卡成功 :%02x %02x %02x %02x", pCode[0], pCode[1], pCode[2], pCode[3]);
...
void C14443AMF::OnInitialization() 
{
	...
	{
		CString str;
		str.Format("操作成功！.. :%02x %02x %02x %02x\r\n", key[0], key[1], key[2], key[3]);
...
void C14443AMF::OnCardNumber() 
{
    ...
    if(re == 0)
	{
        ...
        CString str2;
		str2.Format("卡号 : %02x %02x %02x %02x\r\n", value[0], value[1], value[2], value[3]);
